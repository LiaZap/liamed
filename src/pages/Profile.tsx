    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                ...
                {/* Column 1 - Profile Card (40% desktop, 1/5 cols in grid) */}
                <Card className="md:col-span-2 shadow-sm dark:bg-[#222428] dark:border-slate-800">
                    <CardContent className="pt-8 px-8 pb-8 flex flex-col items-center text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            <h2 className="text-xl font-bold text-slate-900 dark:text-slate-50">Tiago Carlos Sulzbach</h2>
                        ...
                        <div className="w-full space-y-4 pt-2">
                            <div className="flex justify-between items-center border-b pb-2 dark:border-slate-800">
                                ...
                                <span className="text-sm font-medium dark:text-slate-200">08/09/2025</span>
                            </div>
                            <div className="flex justify-between items-center border-b pb-2 dark:border-slate-800">
                                <span className="text-sm text-muted-foreground">{t('profile.last_access')}</span>
                                <span className="text-sm font-medium dark:text-slate-200">18/12/2025</span>
                            </div>
                        </div>
                ...
                {/* Column 2 - Personal Info (60% desktop, 3/5 cols in grid) */}
                <Card className="md:col-span-3 shadow-sm h-fit dark:bg-[#222428] dark:border-slate-800">
                    ...
                    <CardContent className="p-6 space-y-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-base font-normal text-slate-900 dark:text-slate-100">Tiago Carlos Sulzbach</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-1">
                                ...
                                <p className="text-base font-normal text-slate-900 dark:text-slate-100">tiago.carlos.sulzbach@gmail.com</p>
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-base font-normal text-slate-400 italic">{t('profile.not_informed')}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-base font-normal text-slate-400 italic">{t('profile.no_bio')}</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
                ...
                <DialogContent className="max-w-[600px] w-full p-0 gap-0 bg-white dark:bg-slate-900 dark:border-slate-800">
                    ...
                    <div className="p-6 space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input defaultValue="Tiago Carlos Sulzbach" className="dark:bg-slate-800 dark:border-slate-700" />
                        </div>
                        <div className="space-y-2">
                            <Label className="dark:text-slate-300">{t('profile.phone')}</Label>
                            <Input placeholder="(00) 00000-0000" className="dark:bg-slate-800 dark:border-slate-700" />
                        </div>
                        <div className="space-y-2">
                            <Label className="dark:text-slate-300">{t('profile.address')}</Label>
                            <Input placeholder={t('profile.address_placeholder')} className="dark:bg-slate-800 dark:border-slate-700" />
                        </div>
                        <div className="space-y-2">
                            ...
                            />
                            <p className="text-xs text-right text-muted-foreground">{t('profile.chars_count')}</p>
                        </div>
                    </div>
                    <DialogFooter className="p-6 border-t sm:justify-end gap-2 bg-slate-50/50 dark:bg-slate-900/50 dark:border-slate-800">
                        ...
                        <Button className="bg-[#0066CC] hover:bg-[#0055AA] dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-200">{t('profile.save_changes')}</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
